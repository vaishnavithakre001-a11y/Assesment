...
import { User, Mail, Briefcase, Building, DollarSign, Upload, ArrowLeft, Save, AlertCircle } from "lucide-react";
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <label className="relative cursor-pointer bg-white border border-gray-300 rounded-lg px-4 py-3 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center space-x-2">
